...
public class SXLResourceChecker : EditorWindow
{
    ...
    [MenuItem("SkaterXL/Resource Checker")]
    static void Init()
    {
        SXLResourceChecker window = (SXLResourceChecker)EditorWindow.GetWindow(typeof(SXLResourceChecker));
    ...
    void OnGUI()
    {
        ...
        GUILayout.Space(10);
        GUILayout.BeginHorizontal();
        GUILayout.Label($"(c) 2012-2015 Simon Oliver +  Brice Clocher | https://github.com/handcircus/Unity-Resource-Checker");
        GUILayout.EndHorizontal();
    }
